...
app.controller('myCtrl', function ($scope, $http, $window) {
    ...
    $scope.imageUrl = "https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo3.0@latest/SiteAssets/EmployeeSynchronous/EmployeeDirectory_New/images/user_pic.jpg";
    ...
    $scope.GetAttachment = function (attachmentcollection, EMail) {
        var attachmentUrl = _spPageContextInfo.webAbsoluteUrl + '/_layouts/15/userphoto.aspx?accountname=' + escapeProperly(EMail) //"https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo3.0@latest/SiteAssets/EmployeeSynchronous/EmployeeDirectory_New/images/user_pic.jpg";
    ...
    $("#uploadFile1").on('change', function () {
        if (typeof ($("#uploadFile1")[0].files) != "undefined") {
            ...
            if (size <= 100) {
                ...
                $("#uploadFile1").val(null);
                $('#profile-image1').attr("src", "https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo3.0@latest/SiteAssets/EmployeeSynchronous/EmployeeDirectory_New/images/user_pic.jpg");
                return false;
            }
        }
    });
