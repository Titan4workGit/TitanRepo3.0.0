...
app.controller('myCtrl', function ($scope, $http, $window) {
    ...
    $scope.imageUrl = "https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo3.0@latest/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg";
    ...
    $scope.GetAttachment = function (attachmentcollection) {
        var attachmentUrl = "https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo3.0@latest/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg";
    ...
    $("#uploadFile1").on('change', function () {
        if (typeof ($("#uploadFile1")[0].files) != "undefined") {
            ...
            if (size <= 50) {
                ...
                $('#profile-image1').attr("src", "https://cdn.jsdelivr.net/gh/Titan4workGit/TitanRepo3.0@latest/SiteAssets/EmployeeSynchronous/EmployeeDirectory/user_pic.jpg");
                return false;
            }
        }
